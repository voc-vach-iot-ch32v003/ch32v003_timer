 ...
 * @details Hàm này bọc lại bộ đếm SysTick 32-bit phần cứng của lõi RISC-V
 * [ch32fun].
...
/**
 * @brief Trả về số micro-giây (us) đã trôi qua kể từ khi vi điều khiển khởi
 * động.
...
/**
 * @brief Trả về số mili-giây (ms) đã trôi qua kể từ khi vi điều khiển khởi
 * động.
...
/**
 * @brief Tính toán khoảng thời gian (us) thực tế đã trôi qua giữa hai mốc thời
 * gian micros.
 * @details Tự động xử lý chính xác hiện tượng tràn số (Rollover) của thanh ghi
 * đếm 32-bit.
...
/**
 * @brief Tính toán khoảng thời gian (ms) thực tế đã trôi qua giữa hai mốc thời
 * gian millis.
 * @details Tự động xử lý chính xác hiện tượng tràn số (Rollover) của thanh ghi
 * đếm 32-bit.
